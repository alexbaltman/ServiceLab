...
@click.option('--nfs',
              is_flag=True,
              default=False,
              help="The .stack/services folder will be nfs mounted. "
                   "NFS configuration is managed by Vagrant. Vagrant may prompt for "
                   "administation privileges unless /etc/sudoers file has been "
                   "setup on the host system. Please check Vagrant documentation "
                   "on this.")
@click.group('up',
